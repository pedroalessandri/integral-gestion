    ...
    <div className="space-y-6 max-w-5xl animate-pulse">
      ...
      >
        ...
        >
          ...
          <div className="h-3 w-28 rounded" style={{ backgroundColor: 'var(--color-neutral-200)' }} />
        ...
        {Array.from({ length: 4 }).map((_, i) => (
          ...
          >
            ...
            <div className="h-3 w-28 rounded" style={{ backgroundColor: 'var(--color-neutral-100)' }} />
            <div className="h-6 w-16 rounded-full" style={{ backgroundColor: 'var(--color-neutral-100)' }} />
